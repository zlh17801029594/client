...
public class SsoUtils {
	 ...
	 * @since 4.1
	 */
	public SsoUtils(String pathSeparator) {
...
//	@Override
	 ...
	 * <p>The default implementation checks this SsoUtils's internal cache
...
//	@Override
	...
	public static void remove(HttpServletRequest request, HttpServletResponse response, String key) {
		Cookie cookie = get(request, key);
		if (cookie != null) {
			setCookie(response, key, "", 0, COOKIE_PATH);
		}
	}
	...
	public static <T> T readValue(String jsonStr, Class<T> clazz) {
		try {
			...
			logger.error("read json string to object fail.JsonString:"+jsonStr+",object:"+clazz,e);
		}
		return null;
	}
}
